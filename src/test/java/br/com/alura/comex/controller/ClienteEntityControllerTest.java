...
//
//        clienteDAO.save(new ClienteEntity("Kelvin", 4156667228L, "198273666444", DEFAULT_ENDERECOEntity));
//        clienteDAO.save(new ClienteEntity("Amanda", 4156667228L, "198273666444", DEFAULT_ENDERECOEntity));
//
